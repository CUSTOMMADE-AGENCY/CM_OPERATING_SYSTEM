...
De repository wordt opnieuw uitgelijnd op de actuele CM-bedrijfsstructuur. De template-freeze uit de recoveryfase is opgeheven: templates mogen nu worden aangevuld en aan Drive-mappen gekoppeld. De koppeling template↔Drive-map is vastgelegd in `docs/00_GOVERNANCE/MAP_SPECIFICATIONS/TEMPLATE_PLACEMENT_MAP.md`.
...
De canonieke Template Library staat onder `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/`. Welke template in welke Google Drive-map thuishoort, is vastgelegd in `docs/00_GOVERNANCE/MAP_SPECIFICATIONS/TEMPLATE_PLACEMENT_MAP.md`.
