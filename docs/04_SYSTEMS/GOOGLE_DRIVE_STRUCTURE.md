...
Gebruik `scripts/google_drive/create-cm-drive-structure.gs` om de rootfolder `OS_CUSTOMMADE`, alle goedgekeurde rootfolders, alle goedgekeurde tweede niveaus, alle artistfolders en alle standaard artist subfolders aan te maken.
