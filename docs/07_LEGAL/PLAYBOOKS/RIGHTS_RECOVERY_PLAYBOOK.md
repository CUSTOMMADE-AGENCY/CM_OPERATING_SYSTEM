...
- Contracts en split sheets.
- Distribution/admin/publisher dashboards.
...
- Client.
- Publishers/admins/distributors/labels.
- PROs/CMOs.
...
- Maak per issue een evidence packet met brondata en gevraagde correctie.
- Dien claims in via juiste portal of contactpersoon en volg strak op.
...
3. Review statements op missing periods, unusual drops, unmatched income, reserves en territory gaps.
4. Maak issue log met categorie, estimated value, evidence, owner, payor en deadline.
5. Verzamel bewijs: contracts, split sheets, screenshots, prior statements en registration confirmations.
6. Dien correctie of claim in via portal/email met concreet verzoek en bewijs.
7. Plan follow-up cadence: 7 dagen ontvangstbevestiging, 14 dagen inhoudelijke status, daarna escalatie.
8. Verwerk responses en update issue log.
...
- Payor weigert correctie zonder legal escalation.
