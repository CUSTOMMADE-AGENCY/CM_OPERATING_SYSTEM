...
- Distribution status en DSP pitching deadlines.
- Content assets, EPK, bio, press images en links.
- Marketingbudget en kanaalplan.
...
- Zorg dat metadata, artwork, credits en delivery foutloos zijn vóór distributiedeadlines.
- Pitch DSP’s met duidelijke positioning, vergelijkbare context en campagnebewijs.
- Plan content rond verhaal, performance, behind-the-scenes, short-form hooks en community engagement.
...
3. Maak campaign brief: positioning, key message, target audience, proof points en release narrative.
4. Maak content calendar voor minimaal vier fases: announcement, pre-release, release week en post-release.
5. Dien DSP pitch op tijd in met genre, mood, context, marketingplan en vergelijkbare artiesten.
6. Maak press kit en benader media volgens prioriteit.
7. Selecteer influencers op audience fit, geloofwaardigheid en meetbaarheid; bevestig deliverables schriftelijk.
8. Monitor pre-save, content engagement en early feedback.
9. Op release day: controleer links, DSP visibility, social posts, mailing, press en creator posts.
...
- ClickUp campaign board.
- Canva/Adobe voor assets.
...
- Streams per DSP.
- Playlist adds.
- Saves, shares en listener growth.
- Content views, engagement en retention.
- Press placements.
...
- Release date verschuift zonder stakeholder alignment.
