...
- Brand assets, socials, audience data en press history.
- Revenue overview: shows, streaming, publishing, sync, merch, brand, grants.
...
- Artist/client.
- CM development lead.
- Manager of internal project owner.
...
- Audience work bepaalt waar fans zitten, welk gedrag zij tonen en welke kanalen prioriteit krijgen.
- Music planning koppelt releases, live, writing en catalog exploitation.
...
3. Maak brand gap list: bio, visuals, socials, website, press kit, tone of voice.
4. Plan music roadmap: schrijven, opnemen, releases, live moments en exploitation.
5. Maak revenue map met huidige inkomsten, quick wins en 12-maanden targets.
6. Maak team map met rollen, eigenaars, ontbrekende functies en hiring priorities.
7. Vertaal alles naar 90-dagen execution plan met weekly actions.
...
- Artist heeft geen operationeel ritme.
...
- Cash runway onvoldoende voor plan.
