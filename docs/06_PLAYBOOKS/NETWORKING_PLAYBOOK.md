...
- Events, conferences en market moments.
...
- Bereid elke meeting voor met doel, context, give-first value en mogelijke next step.
- Leg na elk contact vast wat besproken is, welke belangen spelen en wanneer opvolging nodig is.
...
3. Plan maandelijkse outreach naar prioritaire relaties met concrete aanleiding.
4. Bereid meeting brief voor: doel, talking points, vragen, CM update en mogelijke ask.
5. Voer gesprek professioneel: luister naar mandaten, criteria, pijnpunten en timing.
6. Log notes binnen 24 uur in CRM/ClickUp.
7. Stuur follow-up met samenvatting, beloofde links en volgende stap.
8. Vraag introducties alleen wanneer fit en timing helder zijn.
...
- Dealflow uit netwerk.
- Buyer/referral quality.
...
- Relatie heeft reputatieproblemen.
