...
- Teaser zonder vertrouwelijke details.
- NDA-template en toegangscriteria.
- Buyer universe, eerdere interacties en conflict checks.
...
- Kopers: fondsen, publishers, labels, distributors, private buyers, family offices of strategische partijen.
...
- Stuur alleen een teaser als de buyer past bij de asset en CM de communicatie kan controleren.
- Laat NDA ondertekenen vóór identificerende details, financiële brondata of dataroomtoegang worden gedeeld.
- Volg een vaste follow-up cadence: dag 0 outreach, dag 3 reminder, dag 7 call request, dag 14 statusvraag, daarna alleen relevante updates.
- Geef dataroomtoegang gefaseerd: teaserfase, NDA-fase, financial review, full diligence.
...
3. Scoor buyers op fit, kapitaal, snelheid, track record, vertrouwelijkheid en strategische waarde.
4. Maak een shortlist en vraag seller approval voordat outreach start.
5. Finaliseer teaser: asset type, genre, inkomstenindicatie op hoog niveau, groeiverhaal, rechtenperimeter en procesinstructie.
6. Stuur persoonlijke outreach per buyer met duidelijke call-to-action: NDA aanvragen, call boeken of pas bevestigen.
7. Registreer elke reactie in ClickUp of CRM met datum, status, eigenaar en vervolgstap.
8. Verstuur NDA alleen aan gekwalificeerde buyers en track ondertekening.
9. Na NDA: deel process letter, dataroomregels en toegestane informatie.
10. Open dataroomtoegang per persoon, niet per organisatie, en verwijder toegang zodra de buyer afhaakt.
11. Organiseer Q&A centraal; geef geen afwijkende antwoorden aan individuele buyers zonder logging.
12. Vraag indicatieve biedingen in hetzelfde format: prijs, asset perimeter, structuur, financiering, aannames, closing timeline en voorwaarden.
13. Maak een offer comparison sheet en bespreek met seller.
...
- NDA conversion rate.
- Dataroom engagement.
- Aantal indicatieve biedingen.
- Tijd van outreach tot eerste bod.
...
- Buyers vergelijken niet dezelfde asset perimeter.
- Seller deelt parallel informatie buiten CM om.
...
- Buyer probeert rechtstreeks met seller te communiceren zonder CM.
- Buyer lekt informatie, vraagt naar andere bieders of gebruikt agressieve tactieken.
