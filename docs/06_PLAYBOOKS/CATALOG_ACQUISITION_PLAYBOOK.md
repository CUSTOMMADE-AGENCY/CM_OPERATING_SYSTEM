...
- Royalty statements en source reports.
- Contracten, amendments, side letters en chain-of-title documenten.
- Splitinformatie, claims, samples, liens en recoupmentposities.
...
- Tax/accounting advisor indien nodig.
...
3. Controleer contracten op ownership, term, reversion, territory, assignment, consent, restrictions en audit rights.
4. Maak een royalty data room: statements per payor, periode en income type.
5. Reconcileer royalty statements met bronrapporten en markeer gaps.
6. Normaliseer omzet: TTM, meerjarige trend, non-recurring, reserves, fees, recoupment en platformmix.
7. Bouw een valuation memo met low/base/high cases en diligence adjustments.
8. Maak buyer target list op basis van genre, asset type, ticket size, rechtenfit en strategic use.
9. Bereid teaser, NDA, dataroom en Q&A-log voor.
10. Verzamel en vergelijk LOI’s op prijs, structuur, holdback, exclusiviteit, financiering en closing conditions.
11. Selecteer preferred counterparty en definieer diligence workstream.
12. Beantwoord diligencevragen uitsluitend via Q&A-log en update dataroom gecontroleerd.
13. Onderhandel APA: purchase price, asset schedule, reps, warranties, indemnity, covenants, closing deliverables en post-closing payments.
...
- Rights review memo.
- Financial review workbook.
- Valuation memo.
- Buyer target list.
- Teaser en process letter.
- LOI comparison.
...
- Revenue reconciliation completeness.
- LOI-to-close conversion.
- Diligence issue resolution time.
...
- Seller verwacht prijs zonder bewijsbasis.
- Buyer gebruikt diligence om prijs disproportioneel te drukken.
...
- Royalty statements tonen grote unexplained drops.
- Seller weigert documenten te delen.
