...
- One-stop status of clearance matrix.
- Mood, tempo, genre, lyrics en use-case tags.
...
- Supervisor outreach is gericht op briefs, smaak, relatie en timing; geen bulkspam.
- Pitching gebruikt korte context, streaming/private links en duidelijke clearance status.
...
3. Markeer repertoire als one-stop, controlled maar multi-party, of complex clearance.
4. Tag tracks op mood, tempo, genre, lyrics, scene use en vergelijkbare referenties.
5. Bouw supervisor/contact list per segment: film, TV, ads, games, trailers, brands.
6. Reageer op briefs binnen deadline met maximaal passende keuzes en duidelijke rechtenstatus.
7. Pitch proactief alleen repertoire dat past bij supervisorprofiel.
8. Bij interesse: bevestig use, media, territory, term, budget, deadline en edit needs.
9. Vraag approvals bij alle rechthebbenden volgens protocol.
...
- Brief response time.
- Pitch-to-interest rate.
- Interest-to-license conversion.
- Gemiddelde sync fee.
...
- Conflicterende master/publishing splits.
