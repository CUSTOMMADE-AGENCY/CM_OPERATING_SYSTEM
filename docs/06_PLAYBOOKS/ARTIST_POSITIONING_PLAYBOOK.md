...
- Audience wordt beschreven op gedrag, cultuur en behoefte; niet alleen demografie.
...
3. Kies 1 primaire en maximaal 2 secundaire archetypes als interne richtlijn.
4. Beschrijf kernverhaal in vijf zinnen: wie, waarvandaan, conflict, visie, waarom nu.
5. Definieer audience segments met gedrag, platformen, culturele referenties en behoefte.
6. Maak differentiatiematrix versus 5 vergelijkbare acts.
7. Schrijf messaging: one-liner, short bio, long bio, release angle, press angle en brand angle.
8. Test messaging tegen artistgevoel, teambegrip en externe bruikbaarheid.
...
- Audience wordt te breed gedefinieerd.
...
- Claims over cultuur, background of achievements zijn niet verifieerbaar.
