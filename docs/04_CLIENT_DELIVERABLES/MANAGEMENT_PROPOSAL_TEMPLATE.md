...
| Veld | Informatie |
| --- | --- |
| Client | Naam artiest, onderneming of vertegenwoordiger |
| Artist | Artiestennaam en juridische naam indien relevant |
| Prepared by | Custommade Agency management lead |
| Proposal date | Datum van voorstel |
| Version | v1.0 draft, v1.1 negotiated, v2.0 final of amendment |
| Status | Internal Draft, Presented, Negotiation, Approved, Declined of Archived |
| Proposed term | Retainer, projectmanagement, launch sprint, management pilot of full managementperiode |
...
- Artist Audit: merkpositie, artist DNA, doelgroep, zichtbaarheid en ontwikkelprioriteiten.
- Business Audit: teamrollen, zakelijke infrastructuur, financiële basis, contractuele beperkingen en business readiness.
- Rights Audit: rights readiness, blocked repertoire, collection gaps en approval requirements.
- Artist Roadmap: 6-12 maanden doelen, prioriteiten, mijlpalen en afhankelijkheden.
- Release Strategy: komende releases, campaign roles, commerciële opportunities en reporting cadence.
- Clientgesprekken: ambitie, grenzen, werkstijl, besluitvorming, budget, risicobereidheid en gewenste managementvorm.
...
| Onderdeel | Voorstel |
| --- | --- |
| Managementvorm | Strategic management, day-to-day management, projectmanagement, launch sprint, rights cleanup coordination of pilot |
| Primaire focus | Artist development, release execution, rights management, revenue growth, partnerships, sync, live of teamstructuur |
| Termijn | Gefaseerd met evaluatiemomenten na 30, 60 en 90 dagen en daarna maandelijks |
| Fee model | Retainer, project fee, commission, hybrid model of success fee uitsluitend volgens schriftelijke overeenkomst |
| Startvoorwaarde | Go of conditional go uit Rights Audit, heldere teammandaten, budgetapproval en documenttoegang |
| No-go criteria | Onopgeloste eigendomsclaims, verborgen deals, ontbrekende approvalbevoegdheid, onrealistische verwachtingen of structurele non-response |

**Management principles**

1. CM beheert geen chaos; CM bouwt schaalbare artist business op basis van bewijs, rechtencontrole en heldere beslissingen.
2. Artistieke keuzes blijven bij de artiest; CM bewaakt strategie, marktpositie, teamcoördinatie, commerciële haalbaarheid en execution discipline.
3. Commerciële groei volgt pas na controle over masters, publishing, collection, budgetten en approvals.
4. Iedere managementactie moet herleidbaar zijn naar Artist Roadmap, Release Strategy of een goedgekeurde opportunity.
5. Maandelijkse reporting is verplicht: zonder meetbare voortgang geen premium managementrelatie.

---

## 3. MANAGEMENT FRAMEWORK

| Domein | CM-verantwoordelijkheid | Client-verantwoordelijkheid | Output |
| --- | --- | --- | --- |
...
| --- | --- | --- | --- |
| Release growth | Releases zijn het bewijs van marktfit en fanactivatie | Strategie, campaign discipline, channel owners en reporting | Saves, engagement, audience growth, conversion en revenue signalen |
| Publishing & sync | Composities kunnen waarde opbouwen buiten streaming | Rights cleanup, metadata pack, sync shortlist en publisher alignment | Clearable repertoire en snelle approval route |
| Brand partnerships | Artist identity kan commerciële cultuurwaarde hebben | Partnerfit, proposition, usage boundaries en deliverables | Merkwaarde zonder artistieke verwatering |
| Live & events | Live bouwt bewijs, inkomsten en community | Booker assets, showstrategie, regional data en performance proof | Vraag, feeontwikkeling, ticketing en audience overlap |
| Catalogus monetisation | Bestaand repertoire kan worden gereactiveerd | Catalogusdata, playlisting, content refresh, sync en anniversary hooks | Rights-ready tracks met bewezen of herwinbare vraag |
| Direct-to-fan | Community kan omzet en loyaliteit dragen | Drops, exclusieve content, mailinglist en fan rituals | Engagementdiepte en betaalbereidheid |
| Strategic partnerships | Producenten, labels, publishers, media en creators kunnen schaal versnellen | Partner mapping, introstrategie en deal guardrails | Controle over rechten, data en artistieke positie blijft behouden |
...
| Verwachtingen niet marktconform | Frictie over tempo, inkomsten of zichtbaarheid | Objectives en KPI’s vooraf goedkeuren | 30/60/90 evaluation gates |
| Geen financiële transparantie | Revenue forecasting en commission tracking onmogelijk | Statements en bankdata delen | Revenue dashboard en accountant alignment |
| Teamoverload | Kwaliteit en deadlines zakken | Rollen faseren en leveranciers begrenzen | Capacity review per maand |
...
3. Combineer management niet met onduidelijke label-, publishing- of producerclaims zonder juridisch advies.
...
- Deal past bij artist positioning en lange termijn roadmap.
- Master, publishing, content en merkrechten blijven controleerbaar.
- Term, territorium, exclusiviteit, options, recoupment en deliverables zijn helder.
- Commission, fee, costs en payment flow zijn inzichtelijk.
- Legal counsel heeft contractuele risico’s beoordeeld.
- Artist heeft finale creative en business approval gegeven.
...
| --- | --- | --- |
| Proposal approval | Voor start van elke managementrelatie | Artiest / rechtspersoon + CM lead |
| Legal approval | Managementcontract, commission, exclusiviteit, dealconflict of rights dispute | Entertainmentadvocaat |
