...
| [CLIENT_ONBOARDING_TEMPLATE.md](TEMPLATES/CLIENT_ONBOARDING_TEMPLATE.md) | Contract, betaling, Drive, ClickUp, kick-off, assets en team alignment controleren voordat uitvoering start. | Operations Manager | Goedgekeurd | Voor elke nieuwe client of nieuwe projectfase. | OS_CUSTOMMADE/00_ADMIN/03_TEMPLATES; operationele kopie naar `01_ADMIN` van het relevante dossier en ClickUp-taken. | Per kwartaal of bij wijziging van onboardingproces. |
