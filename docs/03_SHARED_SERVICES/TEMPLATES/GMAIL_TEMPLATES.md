...
Documenteer Gmail-template-inventory en Governance.

## Template-naamgeving

Gebruik: `CM - Lane - Purpose`.

Voorbeelden:

- `CM - Master Boutique - NDA Follow Up`
- `CM - Artist Management - Onboarding Welcome`
- `CM - Shared - Meeting Recap`

## Regels

- Templates bevatten geen vertrouwelijke clientdetails.
- Materiële approvals worden expliciet en schriftelijk bevestigd.
- Templates worden periodiek gereviewd op toon, juistheid en actualiteit.
