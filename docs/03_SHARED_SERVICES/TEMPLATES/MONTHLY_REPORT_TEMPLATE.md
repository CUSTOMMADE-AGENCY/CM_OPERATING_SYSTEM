...
| Artist / Project | Artiestennaam, releasecampagne, managementperiode of rights project |
| Reporting month | Maand en jaar waarop het rapport betrekking heeft |
| Prepared by | Custommade Agency account, management of strategy lead |
| Version | v1.0 draft, v1.1 reviewed, v2.0 final |
| Status | Internal Draft, Client Review, Approved of Archived |
| Connected deliverables | Artist Audit, Business Audit, Rights Audit, Artist Roadmap, Release Strategy en Management Proposal |
| Next review | Datum van maandmeeting of kwartaalreview |

**Purpose**
Dit monthly report is het accountability-document voor de volledige client journey. Het laat maandelijks zien wat er is gedaan, wat het effect is op artist development, rights management, releases, revenue, partnerships, sync en management, welke risico’s openstaan en welke beslissingen nodig zijn voor de volgende maand. Het rapport voorkomt dat strategie verdwijnt in losse calls, chats of dashboards.

**Scope**
Het rapport behandelt voortgang op roadmap, releasecampagnes, rechtenacties, revenue streams, content en fanontwikkeling, commerciële opportunities, partnerships, sync, live, teamoperatie, budgetsignalen, risico’s, aanbevelingen en approvals. Het vervangt geen boekhouding, juridisch advies of platformstatement; het vertaalt die informatie naar managementbeslissingen.
...
- Monthly executive summary met status, belangrijkste wins, risico’s en beslissingen.
...
| Vraag | Status |
| --- | --- |
| Roadmap op koers? | Op koers, deels op koers, achter op schema of herijking nodig |
...
| Domein | Wat wordt gemeten | Waarom het telt | Beslissing die eruit volgt |
| --- | --- | --- | --- |
...
| --- | --- | --- |
| Audience quality | Saves, repeat listeners, follower conversion, comments met inhoud, shares, mailinglistgroei | Kwaliteit van fanrelatie en kans op duurzame groei |
| Release performance | Streams per bron, playlist adds, completion, skip signalen, territories, UGC en press/radio pickups | Of de release doet waarvoor hij strategisch bedoeld was |
...
- Beoordeel of artist identity, visuals, tone of voice en content deze maand consistenter zijn geworden.
...
- Adviseer of de volgende stap een nieuwe single, content sprint, remix, live activation, sync push of pauze moet zijn.

### Rights management

- Geef status op master ownership, publishing splits, neighbouring rights, sample clearance, Content ID en statementcontrole.
...
- Leg vast welke revenue stream volgende maand actief wordt ontwikkeld.
...
| --- | --- | --- | --- | --- |
| Rights issue | Open, in behandeling, geëscaleerd of gesloten | Release, sync, revenue of reputatie | Rights owner | Bewijs verzamelen, legal review of track blokkeren |
...
3. Verhoog budget alleen wanneer data aantoont dat een kanaal fan conversion, revenue of partnerwaarde oplevert.
4. Gebruik lage performance niet automatisch als reden om harder te posten; analyseer eerst audience fit, content hook, timing en releasefunctie.
5. Escaleer team- of approvalproblemen vroeg, omdat premium management valt of staat met responssnelheid en besluitvorming.
6. Archiveer iedere maand learnings, approvals en decisions zodat kwartaalreview en renewal op feiten gebaseerd zijn.
...
- DSP analytics en distributor statement of dashboard export gecontroleerd.
- Social, YouTube, mailinglist en website/smartlink data verzameld.
...
- Iedere aanbeveling heeft een eigenaar, deadline en approvalstatus.
- Open risico’s zijn geclassificeerd als laag, middel, hoog of kritiek.
- Volgende maand heeft een heldere topprioriteit.
- Budgetbeslissingen zijn gekoppeld aan doel en bewijs.
...
- Approvals schriftelijk bevestigd.
- Roadmap en release strategy waar nodig bijgewerkt.
- Lessons learned gemarkeerd voor kwartaalreview.
...
| --- | --- | --- |
| Report approval | Voor het rapport als maandrecord wordt opgeslagen | Client owner + CM lead |
...
| --- | --- | --- | --- | --- |
| v1.0 | Rapportdatum | CM lead | Eerste maandrapport opgesteld | Draft |
| v1.1 | Reviewdatum | CM + client | Feedback en aanvullende data verwerkt | Client Review |
| v2.0 | Approvaldatum | CM lead | Final report met beslissingen en next actions | Approved |
| v2.1 | Correctiedatum | CM lead | Nacorrectie door late statement, rights update of budgetwijziging | Amended |

**Archiefregel**
Elke maand krijgt een eigen final PDF of markdownversie in de client data room. Amendments blijven gekoppeld aan de oorspronkelijke maand zodat kwartaalreviews, renewals en eventuele disputes kunnen worden teruggeleid naar de exacte informatie en approvals van dat moment.
