...
Deze Folder Standard beschrijft alleen de mapstructuur van een artistdossier. Voor de inhoud van iedere map zijn de Map Specifications leidend: `docs/08_MAP_SPECIFICATIONS/`.
