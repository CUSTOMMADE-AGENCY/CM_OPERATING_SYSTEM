...
| Intake versus onboarding | `ARTIST_INTAKE_FLOW.md`, `01_ARTIST_ONBOARDING_FLOW.md`, `ONBOARDING_CHECKLIST.md`, `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ARTIST_ONBOARDING_TEMPLATE.md` | Intake staat los, maar hoort operationeel vóór of binnen onboarding. | MERGE intake-criteria in onboarding; live intakevragen naar ClickUp. |
| Brand audit versus brandbook | `02_BRAND_AUDIT_FLOW.md`, `ARTIST_BRAND_AUDIT_FLOW.md`, `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/BRAND_AUDIT_TEMPLATE.md`, `03_ARTIST_BRANDBOOK_FLOW.md`, `03_ARTIST_BRANDBOOK_FLOW.md` | Audit findings en brandbook sections lopen deels door elkaar. | Scheid diagnostic output van brand-rule production; behoud template als outputformat. |
...
| Monthly management versus registers | `06_MONTHLY_MANAGEMENT_FLOW.md`, `06_MONTHLY_MANAGEMENT_FLOW.md`, `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/MONTHLY_MANAGEMENT_TEMPLATE.md`, `ARTIST_DELIVERABLES_REGISTER.md`, `ARTIST_APPROVAL_MATRIX.md` | Monthly execution gebruikt dezelfde registers en approvals. | GitHub bewaart definities; live registers en recurring tasks horen in ClickUp. |
...
| Brand Audit, Artist Brand Audit en Brandbook | `BRAND_AUDIT_FLOW.md`, `ARTIST_BRAND_AUDIT_FLOW.md`, `03_ARTIST_BRANDBOOK_FLOW.md` | Gebruik `Artist` alleen wanneer het onderscheidend is; anders verwijderen voor consistentie. |
| ClickUp template versus GitHub template | `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ARTIST_ONBOARDING_TEMPLATE.md`, `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/MONTHLY_MANAGEMENT_TEMPLATE.md`, `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/BRAND_AUDIT_TEMPLATE.md` | Label duidelijk als `ClickUp task template` of `deliverable template`. |
...
| Prefix `ARTIST_` niet consequent | `ARTIST_BRAND_AUDIT_FLOW.md` versus `BRAND_AUDIT_FLOW.md`; `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ARTIST_ONBOARDING_TEMPLATE.md` versus `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ROADMAP_TEMPLATE.md` | Hanteer één prefixstrategie per documenttype. |
...
| Template-namen missen typeonderscheid | `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/BRAND_AUDIT_TEMPLATE.md`, `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/MONTHLY_MANAGEMENT_TEMPLATE.md`, `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ARTIST_ONBOARDING_TEMPLATE.md` | Voeg in titel/omschrijving toe of het een deliverable-template of ClickUp-template is. |
...
| `ARTIST_BRAND_AUDIT_FLOW.md` | ARCHIVE | Korte legacy-audit overlapt met `02_BRAND_AUDIT_FLOW.md` en `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/BRAND_AUDIT_TEMPLATE.md`. |
...
| `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ARTIST_ONBOARDING_TEMPLATE.md` | MOVE_TO_CLICKUP | Beschrijft ClickUp list setup, custom fields, statuses, task groups en automations; hoort als ClickUp-template te worden beheerd. |
...
| `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/BRAND_AUDIT_TEMPLATE.md` | KEEP | Reusable deliverable-template voor audit findings, evidence, decision log en next actions. |
...
| `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/MONTHLY_MANAGEMENT_TEMPLATE.md` | MOVE_TO_CLICKUP | Beschrijft ClickUp list setup, custom fields, recurring task sections en automations; hoort primair in ClickUp. |
...
| `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/RELEASE_STRATEGY_TEMPLATE.md` | KEEP | Reusable deliverable-template voor release overview, strategy, campaign plan, asset readiness, budget, approvals en risks. |
...
| `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ROADMAP_TEMPLATE.md` | KEEP | Reusable deliverable-template voor roadmap context, outcomes, workstreams, risks en monthly review notes. |
...
- `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/BRAND_AUDIT_TEMPLATE.md`
- `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/RELEASE_STRATEGY_TEMPLATE.md`
- `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ROADMAP_TEMPLATE.md`
...
- `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ARTIST_ONBOARDING_TEMPLATE.md`
- `../05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/MONTHLY_MANAGEMENT_TEMPLATE.md`
