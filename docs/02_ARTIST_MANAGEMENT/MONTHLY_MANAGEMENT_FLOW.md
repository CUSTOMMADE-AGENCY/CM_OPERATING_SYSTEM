...
Run recurring artist-management service delivery with clear cadence.
...
1. Hold monthly planning session.
2. Confirm priorities and deadlines.
3. Execute weekly task reviews.
4. Send monthly summary.
5. Reset next-month priorities.
