...
| 2026-07-26 | IN REVIEW | Fase 1 Governance Consolidation: actieve Repository Recovery-governance heeft tijdens recovery voorrang op de V1.0-production-baseline; de ADR blijft behouden als `SUPERSEDED_FOR_RECOVERY`; Map Specifications en historische governance zijn onder `docs/00_GOVERNANCE/` geconsolideerd. Geen vervolg of merge zonder expliciete goedkeuring. |
