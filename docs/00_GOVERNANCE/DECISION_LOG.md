...
| 2026-06-15 | LOCKED | CM en EXTERNE_ENTITEIT blijven strikt gescheiden |
...
| 2026-08-07 | LOCKED | Canonieke ClickUp-structuur = de compacte `CUSTOMMADE AGENCY`-structuur (B): 5 folders PIPELINE/CLIENTS/OPERATIONS/DEAL DESK/MARKETING, artist mgmt onder CLIENTS. De 6-folder `CM`-structuur (A) is gedeprecate. Space-naam geharmoniseerd naar `CUSTOMMADE AGENCY` (live typefout `CUSTOMMMADE` te corrigeren). Ref: ADR-2026-08-07. |
...
| 2026-07-26 | IN REVIEW | Fase 2 centraliseert operationele documentatie onder `docs/05_OPERATIONS/`; inhoudelijk afwijkende rootvarianten van CM FLOW, MONEY en OPS blijven behouden tot afzonderlijke inhoudelijke consolidatie. |
