...
| Gebaseerd op | `docs/05_OPERATIONS/KNOWLEDGE_BASE/SYSTEMS/DRIVE_MAPPING.md`, `docs/00_GOVERNANCE/DRIVE_STRUCTURE.md`, `docs/00_GOVERNANCE/ARTIST_FOLDER_STANDARD.md`, `docs/02_ARTIST_MANAGEMENT/` |
...
|---|---|---|
| Artist Onboarding Template | `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ARTIST_ONBOARDING_TEMPLATE.md` | `02_ARTIST_MANAGEMENT/[ARTIST]/01_ADMIN` |
| Brand Audit Template | `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/BRAND_AUDIT_TEMPLATE.md` | `02_ARTIST_MANAGEMENT/[ARTIST]/03_STRATEGY` |
| Roadmap Template | `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/ROADMAP_TEMPLATE.md` | `02_ARTIST_MANAGEMENT/[ARTIST]/03_STRATEGY` |
| Release Strategy Template | `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/RELEASE_STRATEGY_TEMPLATE.md` | `02_ARTIST_MANAGEMENT/[ARTIST]/04_RELEASES` |
| Monthly Management Template | `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/ARTIST_MANAGEMENT/MONTHLY_MANAGEMENT_TEMPLATE.md` | `02_ARTIST_MANAGEMENT/[ARTIST]/03_STRATEGY` |
| Client Profile Template | `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/CLIENT_PROFILE_TEMPLATE.md` | `02_ARTIST_MANAGEMENT/[ARTIST]/01_ADMIN` |
| Email Instructions Template | `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/EMAIL_INSTRUCTIONS_TEMPLATE.md` | `02_ARTIST_MANAGEMENT/[ARTIST]/01_ADMIN` |
| Do Nots Template | `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/DO_NOTS_TEMPLATE.md` | `02_ARTIST_MANAGEMENT/[ARTIST]/01_ADMIN` |
