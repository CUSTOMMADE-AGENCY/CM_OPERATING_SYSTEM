...
| `docs/08_MAP_SPECIFICATIONS/00_ADMIN.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/01_ADMIN.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/01_MASTER_BOUTIQUE.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/02_ARTIST_MANAGEMENT.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/02_CONTRACT.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/03_CLIENTS.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/03_STRATEGY.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/04_DEALS.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/04_RELEASES.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/05_BOOKING.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/05_OPERATIONS.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/06_FINANCE.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/07_LEGAL.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/07_SOCIALMEDIA.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/08_MARKETING.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/08_PRESS_EPK.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/09_ARCHIVE.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/09_CONTENT.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/99_ARCHIVE.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/MAP_SPECIFICATION_GAP_REPORT.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
| `docs/08_MAP_SPECIFICATIONS/README.md` | **REVIEW_NODIG** | Domein ontbreekt in leidende docs-boom; bepaal governance- of Operations-bestemming zonder Drive te wijzigen. |
