...
- `docs/05_OPERATIONS/KNOWLEDGE_BASE/SYSTEMS/DRIVE_MAPPING.md`
- `docs/05_OPERATIONS/AGENTS/CM_AGENT_ARCHITECTURE.md`
- `docs/05_OPERATIONS/AGENTS/AGENT_RESPONSIBILITY_MATRIX.md`
- `docs/05_OPERATIONS/AGENTS/AGENT_READINESS_CHECKLIST.md`
- `docs/05_OPERATIONS/AGENTS/AGENT_CERTIFICATION_STANDARD.md`
- `docs/05_OPERATIONS/AGENTS/AGENT_LIFECYCLE.md`
- `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/TEMPLATE_ARCHITECTUURSTANDAARD.md`
- `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/TEMPLATE_REGISTER.md`
- `docs/05_OPERATIONS/KNOWLEDGE_BASE/TEMPLATES/00_TEMPLATE_INDEX.md`
