# Buyer Outreach Workflow

## Doel

Voer gecontroleerde outreach naar gekwalificeerde Buyers uit terwijl vertrouwelijkheid en Seller-leverage beschermd blijven.

## Stappen

1. Bouw de Buyer universe op per Buyer-type, mandaat en relatiesterkte.
2. Keur de outreach-lijst intern goed.
3. Verstuur een niet-vertrouwelijke teaser of introductiemail.
4. Log de Buyer-reactie in ClickUp.
5. Plan een kwalificatiecall wanneer interesse is bevestigd.
6. Verstuur een NDA alleen naar gekwalificeerde Buyers.
7. Verleen Data Room-toegang volgens het access model.
8. Bewaak consistente timelines en Q&A-discipline.
