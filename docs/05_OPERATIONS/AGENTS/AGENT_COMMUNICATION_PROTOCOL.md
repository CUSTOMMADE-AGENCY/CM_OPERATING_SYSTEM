...
3. Bij conflict winnen, in deze volgorde:
   1. `docs/05_OPERATIONS/AGENTS/CM_AGENT_ARCHITECTURE.md`
   2. `docs/05_OPERATIONS/AGENTS/AGENT_RESPONSIBILITY_MATRIX.md`
   3. `docs/05_OPERATIONS/AGENTS/AGENT_HANDOFF_MATRIX.md`
   4. `docs/00_GOVERNANCE/GOVERNANCE_RULES.md`
4. Escalatie-inhoud, escalatieniveaus en routes blijven bepaald door `docs/05_OPERATIONS/AGENTS/ESCALATION_PROTOCOLS.md`.
...
Dit protocol vat alleen samen hoe handoffs worden gecommuniceerd. De inhoudelijke handoffregels, triggers, vereiste outputs, vereiste documenten, approvalbehoefte en resultaat blijven bepaald door `docs/05_OPERATIONS/AGENTS/AGENT_HANDOFF_MATRIX.md`.
...
Dit protocol vat alleen samen hoe escalaties worden gecommuniceerd. De inhoudelijke escalatieregels, niveaus, routes en reactietijden blijven bepaald door `docs/05_OPERATIONS/AGENTS/ESCALATION_PROTOCOLS.md`.
