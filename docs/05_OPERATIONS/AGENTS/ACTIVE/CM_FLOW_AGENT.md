...
- Automation backlog en scenario-register: `docs/05_OPERATIONS/AUTOMATIONS/MAKE_SCENARIO_MAP.md`.
- Activatievolgorde en Apps-Script-vs-Make keuze:
  `docs/05_OPERATIONS/AUTOMATIONS/CM_AGENT_ACTIVATION_STRATEGY.md`.
...
- `docs/05_OPERATIONS/AUTOMATIONS/AUTOMATIONS.md` — automatiseringsregister en failure handling.
- `docs/05_OPERATIONS/AUTOMATIONS/MAKE_SCENARIO_MAP.md` — scenario-governance en checklists.
- `docs/05_OPERATIONS/AGENTS/AGENT_DEFINITION_STANDARD.md` — 18-sectiestandaard voor
  agentbouw.
- `docs/05_OPERATIONS/AGENTS/AGENT_COMMUNICATION_PROTOCOL.md` — vaste berichtstructuur voor bouwverzoeken, statusupdates, reviews, handoffs, errors, test-evidence en approval-requests; ondergeschikt aan de responsibility- en handoff-matrices.
