...
- **Weekly consolidated agent digest** (Make, status IDEA in
  `docs/05_OPERATIONS/AUTOMATIONS/MAKE_SCENARIO_MAP.md`) — aggregeert outputs van alle agents,
...
- `docs/05_OPERATIONS/AGENTS/ESCALATION_PROTOCOLS.md` — escalatie-inname en -routing.
- `docs/05_OPERATIONS/AGENTS/AI_AUTONOMY_LEVELS.md` — autonomiegrenzen.
- `docs/05_OPERATIONS/AGENTS/AGENT_RESPONSIBILITY_MATRIX.md` en
  `docs/05_OPERATIONS/AGENTS/AGENT_HANDOFF_MATRIX.md` — eigenaarschap en handoffs.
- `docs/05_OPERATIONS/AGENTS/AGENT_COMMUNICATION_PROTOCOL.md` — vaste berichtstructuur voor escalaties, reviews, approvals, handoffs, errors en audit-evidence; ondergeschikt aan de responsibility- en handoff-matrices.
