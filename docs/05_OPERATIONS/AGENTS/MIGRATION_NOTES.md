...
| CM OPS AGENT | Executie |
| CM PROSPECT AGENT | Executie |
| CM SOCIAL AGENT | Executie |
| CM MONEY AGENT | Executie |
| CM LEGAL AGENT | Bescherming |
| CM VAULT AGENT | Infrastructuur |
| CM FLOW AGENT | Infrastructuur |

## Agentbestandencontrole

De bestaande agentbestanden in `docs/05_OPERATIONS/AGENTS` zijn gecontroleerd. De oude agentdocumenten zijn niet verwijderd, maar verplaatst naar `docs/05_OPERATIONS/AGENTS/HISTORY/LEGACY/`.
...
| `docs/05_OPERATIONS/AGENTS/ACTIVE/CM_MONEY_AGENT.md` | CM Money Agent | CM MONEY AGENT | Nieuwe V1.4-agent voor `06_FINANCE`, Moneybird, BTW, Open Posten, Cashflow, royalty facturen, commission tracking en revenue share controles. |
...
- Legacy agentdocumenten blijven beschikbaar voor historische context in `docs/05_OPERATIONS/AGENTS/HISTORY/LEGACY/`, maar zijn niet leidend.
