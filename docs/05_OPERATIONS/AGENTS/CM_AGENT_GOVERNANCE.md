...
`CM_AGENT_REGISTER.md` is de officiële bron van waarheid voor agentnamen, eigenaarschap en routing. Oude of verkeerde agentdocumenten zijn gearchiveerd in `docs/05_OPERATIONS/AGENTS/HISTORY/LEGACY/` en zijn niet meer leidend.
...
- Output verwijst naar relevante CM-Workflows, playbooks in `docs/05_OPERATIONS/PLAYBOOKS/`, templates of deliverables.
