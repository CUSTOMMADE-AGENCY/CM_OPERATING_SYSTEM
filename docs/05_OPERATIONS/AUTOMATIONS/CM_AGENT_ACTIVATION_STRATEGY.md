...
>
> **Afgeleid document.** Leidend zijn `docs/05_OPERATIONS/AGENTS/CM_AGENT_ARCHITECTURE.md`
> (GOVERNANCE LOCKED) en `docs/05_OPERATIONS/AUTOMATIONS/MAKE_SCENARIO_MAP.md`. Dit document mag
...
Voor agentwijzigingen (`docs/05_OPERATIONS/AGENTS/**`) voegt CM CONTROL de Agent Audit, Agent
...
- `docs/05_OPERATIONS/AGENTS/CM_AGENT_ARCHITECTURE.md` (leidend)
- `docs/05_OPERATIONS/AUTOMATIONS/MAKE_SCENARIO_MAP.md`
- `docs/05_OPERATIONS/AGENTS/ACTIVE/CM_FLOW_AGENT.md`
- `docs/05_OPERATIONS/AGENTS/ACTIVE/CM_CONTROL_AGENT.md`
