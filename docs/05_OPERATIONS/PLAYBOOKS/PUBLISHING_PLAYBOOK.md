...
- PRO/CMO/accountinformatie.
- Admin of publishing agreements.
- Sub-publishing afspraken.
...
- Collection controleert of performance, mechanical, sync en neighboring income correct binnenkomen.
- Splits worden schriftelijk vastgelegd vóór release of pitch.
...
3. Registreer werken bij relevante PRO/CMO/admin volgens ownership en territory.
4. Koppel ISWC, ISRC, titelvarianten en writer IPI’s in metadata sheet.
5. Controleer conflicterende claims en los deze op met bewijsstukken.
6. Review royalty statements per bron en territory; markeer missing income.
7. Monitor sub-publisher performance en lokale registrations.
8. Maak exploitation brief per key work: genre, mood, topline, sync fit, cut potential.
