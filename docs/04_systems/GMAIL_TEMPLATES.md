...
Document Gmail template inventory and governance.
...
- `CM - Artist Management - Onboarding Inputs`
- `CM - Shared - Meeting Recap`

## Rules

- Keep templates clean and reusable.
- Do not store private correspondence in GitHub.
- Review active templates quarterly.
