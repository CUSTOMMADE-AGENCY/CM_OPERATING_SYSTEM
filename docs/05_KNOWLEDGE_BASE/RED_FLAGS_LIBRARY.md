...
De koper mag een betaling, earnout, approval of exploitatiebesluit naar eigen inzicht bepalen. Dit is gevaarlijk wanneer seller afhankelijk is van koperacties voor toekomstige waarde. CM vraagt objectieve criteria, deadlines, reporting en dispute mechanics.

### Unlimited Set-Off

Een partij mag onbeperkt inkomsten verrekenen met kosten, claims of andere projecten. Dit kan royalties jarenlang blokkeren. CM wil set-off beperken tot dezelfde asset, bewezen bedragen, redelijke kosten en duidelijke reporting.
...
Meerdere partijen claimen master, publishing, producer share of royalty entitlement. CM behandelt dit als hoog risico totdat chain of title en contracten duidelijk zijn. Mogelijke mitigatie: excluded asset, holdback, warranty, indemnity of claim resolution vóór closing.

### Missing Split Sheets

Ontbrekende splits maken publishing ownership onzeker. Dit blokkeert registrations, sync clearance en catalog sales. CM vraagt getekende split sheets, writer confirmations of disclosure met prijs-/holdbackimpact.

### Missing Registrations

Works of recordings zijn niet geregistreerd bij Buma/Stemra, SENA, distributor of andere society. Dit kan gemiste inkomsten en ownership gaps veroorzaken. CM maakt een correction plan en waardeert onbekende inkomsten conservatief.

### Oral Agreements

Mondelinge afspraken over rights, royalties, producer fees, features, management of recoupment zijn moeilijk bewijsbaar. CM wil schriftelijke confirmations of nieuwe short-form agreements voordat de deal afhankelijk wordt van die afspraak.

### Unclear Revenue Reporting

Statements zijn incompleet, niet herleidbaar of mengen inkomstenstromen. CM vraagt bronrapporten per payor, periode, right type en repertoire. Zonder reconciliatie wordt revenue lager of risicovoller gewaardeerd.

### Recoupment Risks

Voorschotten, marketingkosten, video costs of labelkosten kunnen inkomsten blokkeren. CM controleert welke kosten recoupable zijn, tegen welke inkomsten, met welke caps en welke reporting beschikbaar is.

### Label Conflicts

Een artist of catalog zit vast aan label options, exclusiviteit, re-recording restrictions, approval rights of delivery obligations. CM checkt of nieuwe deals, syncs of catalog sale hiermee conflicteren.
...
- [ ] Is severity bepaald op ownership, revenue, timing en liability?
- [ ] Is de deal impact gekozen: prijs, holdback, exclusion, warranty, indemnity, KPI, audit right of walk-away?
- [ ] Is legal/tax/accounting review nodig?
