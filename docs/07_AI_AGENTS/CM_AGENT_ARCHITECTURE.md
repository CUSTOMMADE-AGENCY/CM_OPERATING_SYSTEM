...
>
> Bronnen: `CM_AGENT_REGISTER.md` v1.4 · `00_CM_AGENTS_OVERVIEW.md` v1.4 · `AGENT_RESPONSIBILITY_MATRIX.md` v1.4 · `AGENT_HANDOFF_MATRIX.md` v1.4 · `AI_AUTONOMY_LEVELS.md` · `ESCALATION_PROTOCOLS.md` · `AGENT_CERTIFICATION_STANDARD.md` · `AGENT_LIFECYCLE.md` · individuele agent-definities in `docs/07_AI_AGENTS/AGENTS/`
>
