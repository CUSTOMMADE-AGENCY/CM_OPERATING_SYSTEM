...
| `AGENTS/CM_MONEY_AGENT.md` | CM Money Agent | CM MONEY AGENT | Nieuwe V1.4-agent voor `06_FINANCE`, Moneybird, BTW, Open Posten, Cashflow, royalty facturen, commission tracking en revenue share controles. |
