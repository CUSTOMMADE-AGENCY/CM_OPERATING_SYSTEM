...
const CM_TEMPLATE_V22_REGISTRY = [
  ...
  ['01_SHARED_SERVICES', 'CLOSE_OUT_NOTE_TEMPLATE', '01_SHARED_SERVICES/CLOSE_OUT_NOTE_TEMPLATE.md'],
  ...
  ['02_ARTIST_MANAGEMENT', 'ARTIST_BRANDBOOK_TEMPLATE', '02_ARTIST_MANAGEMENT/ARTIST_BRANDBOOK_TEMPLATE.md'],
